...
def upload():
    ...
    if not file or not AUTH_KEY:
        return jsonify({"error": "Chybí soubor nebo API klíč"}), 400
    ...
    try:
        ...
        res = requests.post(API_URL, json={
            "model": "gemma3:27b",
            "messages": [
                {"role": "system", "content": "Jsi JSON generátor. Odpovídej pouze čistým JSONem."},
        ...
        # Odstranění markdown značek, pokud je tam AI dala
